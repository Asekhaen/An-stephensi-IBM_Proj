...
$$
where $d_{ij}$ is the Euclidean distance between patches and $\lambda$ is an exponential decay parameter that controls the decay rate. Each row is then normalised (sum to 1) resulting in conditional probabilities $M_{ij}$ of moving between patches $i$ to $j$. 

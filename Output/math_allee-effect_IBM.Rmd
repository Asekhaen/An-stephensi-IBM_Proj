...
Survival is stage-specific and governed by both intrinsic and extrinsic factors. Intrinsic survival $V$ is the baseline probability $v$ that an individual in any a given location survives regardless of environmental influences and its stage-specific. 
$$
